...
.nav{display:grid;gap:6px}.nav button{width:100%;justify-content:flex-start;text-align:left;background:#fff9ef;color:var(--ink);border:1px solid var(--line);box-shadow:none;padding:11px 12px;display:flex;align-items:center;gap:10px}.nav button::before{content:attr(data-icon);display:inline-flex;align-items:center;justify-content:center;width:28px;height:28px;border-radius:9px;background:#efe3cc;border:1px solid var(--line);font-size:11px;font-weight:700;color:var(--muted)}.nav button.active{background:linear-gradient(135deg,var(--brand),var(--brand2));color:#fff;border-color:transparent}.nav button.active::before{background:rgba(255,255,255,.14);border-color:rgba(255,255,255,.22);color:#fff}.side .meta{display:grid;gap:8px}.chip,.pill{display:inline-flex;align-items:center;gap:6px;border-radius:999px;padding:6px 10px;font-size:12px;white-space:nowrap;border:1px solid var(--line);background:#fdf8ef}.good{color:var(--good)!important}.warn{color:var(--warn)!important}.bad{color:var(--bad)!important}
...
const VIEW_ICONS={overview:"OV",gear:"GE",crafting:"CR",progression:"PR",activity:"AC"};
